...
function PackagesDetails() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const found = response?.find((p) => p.packageID === Number(id));
   ...
   .avail-btn {
      ...
      <div className="details-page-wrapper">
        ...
        <div className="package-details-card">
          <div className="badge-pill">{pkg.packageCategory}</div>

          <h1 className="pkg-title">{pkg.packageName}</h1>
          ...
          <div className="info-row">
            ...
            <span className="info-value">{pkg.durationDays} Days</span>
          </div>

          <div className="info-row">
            <TagIcon />
            <span className="info-label">Category:</span>
            <span className="info-value">{pkg.packageCategory}</span>
          </div>
